...
log_info "Step 4: Waiting for TimeVote finality (67% threshold; 51% fallback after 30s stall)..."
...
if [ "$FINALIZED" = false ]; then
    ...
    log_info "  - Not enough masternodes connected (need ≥67% AVS weight, or ≥51% after 30s stall)"
...
echo "  Weight:         $TIMEPROOF_WEIGHT (≥67% required; ≥51% fallback after 30s stall)"
echo "══════════════════════════════════════════════════════════════"
echo "                      BLOCK ARCHIVAL"
echo "══════════════════════════════════════════════════════════════"
echo "  Block:          $TX_BLOCK"
